...
symfony new my _ project _ directory --version="7.2.x"

symfony new my _ project _ directory --version=lts

symfony new my _ project _ directory --version=next
...
symfony new my _ project _ directory --version="7.2.x" --webapp
...
bin/console cache:pool:clear cache.global _ clearer
